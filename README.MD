...
- **Set the `ProjectFile` Parameter**:
  ...
  - define the `ProjectFile` parameter:

    Select Edit Query and then select the `ProjectFile Parameter and set to your own 

    ProjectFile = "C:\Users\User\Downloads\YourProjectFile.mpp" and replace `"C:\Users\User\Downloads\YourProjectFile.mpp"` with the actual path to your `.mpp` file.
